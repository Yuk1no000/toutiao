...
from sqlalchemy import DATETIME, Integer, String, Index, Text, ForeignKey, DateTime
...
class Category(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="分类ID", autoincrement=True)
